...
export const metadata: Metadata = {
  title: "Archive — Documentary Photography",
  description: "Archive of photographs by Juan C. Nava — documentary portraits, desert landscapes, and street photography from Phoenix, Arizona and the Southwest.",
  alternates: { canonical: "https://juancnava.com/gallery" },
  openGraph: {
    title: "Archive — Juan C. Nava Photography",
    ...
    <div className="min-h-screen bg-bg text-cream font-sans">
      ...
      <main className="px-6 md:px-14 pt-28 pb-24">
        <div className="flex items-baseline justify-between mb-10">
          <h1 className="font-serif font-black text-4xl md:text-5xl text-cream leading-tight">Archive.</h1>
